...
import { AddTeachersComponent } from '../admin-modals/add-teachers/add-teachers.component';
import { AddStudentsComponent } from '../admin-modals/add-students/add-students.component';
import { EditDetailsComponent } from '../admin-modals/edit-details/edit-details.component';
import { APIService } from 'src/app/services/API/api.service';
import { Subscription, firstValueFrom } from 'rxjs';
import { AddPrincipalComponent } from '../admin-modals/add-principal/add-principal.component';
...
export class UsersPageComponent implements OnInit, OnDestroy {
  ...
  options = ['Students', 'Teachers', 'Admin'];
  ...
  onClick(event: MouseEvent) {
    ...
    const dropdownElement = document.querySelector('.your-dropdown-class'); // Change this to your dropdown class
