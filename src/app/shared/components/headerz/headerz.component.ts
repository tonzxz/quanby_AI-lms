 ...
 ngOnInit(): void {
    ...
    if (toggle && sidebar) {
      toggle.addEventListener('click', () => {
        ...
        const toggleIcon: HTMLElement | null = body.querySelector('.bx-chevron-right.toggle');
        if (toggleIcon) {
    ...
    if (burger && sidebar) {
      burger.addEventListener('click', () => {
        ...
        const burgerButton: HTMLElement | null = body.querySelector('.bx-chevron-right.toggle');
        if (burgerButton) {
